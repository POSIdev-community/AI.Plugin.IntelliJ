...
- Fixed the errors that occurred when running the plugin in OpenIDE and GIGA IDE.
- Fixed some issues with the built-in assistant and PT AI Enterprise Server integration issues.
